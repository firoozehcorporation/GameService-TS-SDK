...
export class RealTime {
    ...
    protected OnConnect = (e: WebSocket.OpenEvent) => {
        ...
        payload.Token = GameService.Authentication.gameToken;
    ...
    protected OnReceive = (event: WebSocket.MessageEvent) => {
        ...
        switch (packet.Action) {
            ...
            case Actions.RealTime.ActionPublicMessage:
                ...
                GameService.GSLive.RealTime.NewMessageReceived({
                    MessageInfo: {
            ...
            case Actions.RealTime.ActionMembersDetail:
                ...
                GameService.GSLive.RealTime.RoomMembersDetailReceived(members)
                break
            case Actions.RealTime.ActionLeave:
                let member = JSON.parse(BufferToString(packet.Payload!));
                GameService.GSLive.RealTime.OnLeaveRoom(member)
                if (member!.user!.isMe) {
            ...
            case Actions.RealTime.ActionEventMessage:
                ...
                GameService.GSLive.RealTime.OnPropertyEvent({
                    By: evM.SenderID,
                    Name: ev.Name,
            ...
            case Actions.RealTime.ActionRoomInfo:
                ...
                GameService.GSLive.RealTime.CurrentRoomInfoReceived(roomInfo.Export())
                break
            case Actions.Error:
